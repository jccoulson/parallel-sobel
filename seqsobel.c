//Jesse Coulson
//CSCI 551 sequential final program
...
int main(void)
{
    ...
    printf("Doing sequential sobel on %s.bmp\n", FilenameString);
    BMPIMAGE BMPImage1;
    ...
    bmp_write(array_to_raw_image(SobelEdge(RGBImage1.XSIZE, RGBImage1.YSIZE, RGBImage1.IMAGE_DATA), RGBImage1.XSIZE, RGBImage1.YSIZE), BMPImage1.XSIZE, BMPImage1.YSIZE, "SEQSobelTransformOutput");
    return 0;
};
